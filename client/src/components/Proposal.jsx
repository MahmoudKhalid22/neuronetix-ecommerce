...
function Proposal({ onSetActiveLink, observer }) {
  return (
    <div
      id="home"
      className="px-6 pt-32 flex items-start min-h-screen justify-start flex-col overflow-x-hidden"
    >
      ...
      <p className="mt-8 leading-[1.5rem] sm:leading-[2.5rem]  text-sm sm:text-[1.5rem] sm:w-[60%]">
      ...
      <div className="flex sm:flex-row flex-col justify-start items-start mt-8 gap-8 sm:gap-0">
        <HashLink smooth to={"/#about"}>
          <button className="py-1 sm:py-2 px-2 mt-8 sm:px-4  font-bold text-sm sm:text-xl bg-[#ec981a] hover:bg-[#d48917] text-[#f5f5f5] transition-colors duration-300 rounded-sm ">
            Explore Printers
          </button>
        </HashLink>
      </div>
